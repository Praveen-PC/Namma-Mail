...
//         if(!email) newerror.email="Phone Number  Required"
...
//         }
//         try{
//             // const response=await axios.post('http://localhost:8080/api/adduser',{name,email,password})
//            const response=await axios.post(`${API_URL}/api/adduser`,{name,email,password})
...
//                 <input className='form-control' type="text" value={email}  onChange={(e)=>setemail(e.target.value)} placeholder='Enter Phone No' />
